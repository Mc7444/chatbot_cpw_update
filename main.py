...
recived_txt="ถามไปก็ไม่เคยมาอ่านหรือตอบ แย่มาก"  
text = [recived_txt]
...
if(predictions[0]==0): 
    ...
    text_type = "question"
    split_text = split_word(recived_txt)                   # แยกคำจากข้อความใช้ฟังก์ชัน split_word
...
sql_connector.val(recived_txt,text_type,response_check)
