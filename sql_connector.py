...
sql_command = "INSERT INTO category (recive_text,text_type,response_check) VALUES (%s, %s, %s)"
...
def val(z,k,m):
    ...
    db_cursor.execute(sql_command,(x1, x2, x3)) # Execute คำสั่ง SQL โดยใช้ค่า x1 และ x2 ที่กำหนดในตาราง "category" ผ่าน cursor.
    connection.commit()
